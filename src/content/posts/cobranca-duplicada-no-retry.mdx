...
A janela some porque verificar e gravar passam a ser a mesma operação. Aperte o play ou arraste sobre a lousa para ver os cinco passos, contados logo abaixo dela.
